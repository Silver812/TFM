...
echo "" | tee -a $LOG_FILE
COMMON_PARAMS="--num_games 200 --num_threads 10 --num_training 5"

# Configurations
run_training "Fixed Mode Training HoF 3" "$COMMON_PARAMS --max_evaluations 500 --pop_size 10 --intra_run_hof_size 3 --evaluation_mode fixed"
FIXED_STATUS=$?

run_training "Hybrid Mode Training HoF 3" "$COMMON_PARAMS --max_evaluations 500 --pop_size 10 --intra_run_hof_size 3 --evaluation_mode hybrid --hybrid_schedule_str fixed:0.4,coevolution:0.2,fixed:0.4"
HYBRID_STATUS=$?

run_training "Coevolution Mode Training HoF 3" "$COMMON_PARAMS --max_evaluations 500 --pop_size 10 --intra_run_hof_size 3 --evaluation_mode coevolution"
COEVO_STATUS=$?

# run_training "Fixed Mode Training HoF 0" "$COMMON_PARAMS --max_evaluations 500 --pop_size 10 --intra_run_hof_size 0 --evaluation_mode fixed"
# FIXED_STATUS2=$?
...
# Usage instructions:
# chmod +x run_all_trainings_hof.sh
# nohup ./run_all_trainings_hof.sh &
